...
import "./main.css";
import { wordTrim } from "../utils/helpers";
...
const TodoCard = (props) => {
  ...
  const { openEditModal, viewNoteModal } = modalOpenner();
  ...
  return (
    ...
    >
      ...
      <p className="tracking-wide text-base">{wordTrim(description, 250)}</p>
